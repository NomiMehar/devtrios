...
import styles from "./AiAutomationServiceFor.module.scss";

export default function AiAutomationServiceFor({ data }) {
  ...
  return (
    <section className={styles.ai_automation_service_for}>
