      ...
      <div className="container">
        <div className={style.footer_container}>
          ...
          <div className={style.footer_section}>
            ...
            <div className={style.un_badge_wrapper}>
              <Link
                href="http://un.yourdevz.com/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                <Image
                  ...
                  width={50}
                  height={50}
                  className={style.un_badge_icon}
                />
                <div className={style.un_badge_text}>
                  <span className={style.un_badge_title}>UNITED NATIONS</span>
                  <span className={style.un_badge_subtitle}>GLOBAL COMPACT</span>
                </div>
                <svg
                  width="18"
                  height="18"
                  ...
                  className={style.un_badge_arrow}
                >
                  <path
